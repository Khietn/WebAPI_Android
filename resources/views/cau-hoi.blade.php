...
@section('main-content')
            <div class="container-fluid">
                                    ...
                                    <button class="btn btn-success waves-effect waves-light" type="button" id="btnThem" style="margin-bottom:20px">Thêm</button>                  
                                        <table id="tech-companies-1" class="table table-striped"  border="2">
                                            ...
                                            <tr>
                                                ...
                                                <button class="btn btn-outline-success waves-effect waves-light" type="button" >Chinh sua</button>
                ...
                <!-- end form -->
                <!-- form cap nhat -->
                <div class="row" id="form-them-cau-hoi 2 " style="display:none;">
                    <div class="col-md-12">
                        <form class="form-horizontal" action="{{route("cau-hoi.them")}}" id="formThemCauHoi" method="POST"> <!-- Form start2-->
                        @csrf
                            <div class="col-md-7 float-left">
