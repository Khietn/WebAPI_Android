...
Route::prefix('linh-vuc')->group(function(){
	Route::get('/','LinhVucController@data')->name('danhsach');
...
Route::prefix('chi-tiet-luot-choi')->group(function(){
	...
	Route::get('/tim-kiem','ChiTietLuotChoiController@search')->name('chi-tiet.tim-kiem');
});
...
Route::prefix('cau-hoi')->group(function(){
	...
	Route::get('danh-sach/tim-kiem','CauHoiController@search')->name('cau-hoi.tim-kiem');
});
});
//Kết Thúc Chứng Thực
 //dang nhap
